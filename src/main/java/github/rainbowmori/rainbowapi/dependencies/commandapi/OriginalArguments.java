...
public class OriginalArguments {
  ...
  public static final String[] material = Arrays.stream(Material.values()).map(Enum::name)
      .toArray(String[]::new);
  ...
  public static Argument<Material> materials(String nodeName) {
    return new CustomArgument<>(new StringArgument(nodeName), info -> {
      ...
      if (material == null) {
        throw CustomArgumentException.fromMessageBuilder(new MessageBuilder("Unknown material : ").appendArgInput());
      }
      return material;
  ...
  public static Argument<Player> onlinePlayer(String nodeName) {
    return new CustomArgument<>(playerNames(nodeName), info -> {
      ...
      if (player == null) {
        throw CustomArgumentException.fromMessageBuilder(new MessageBuilder("Unknown player : ").appendArgInput());
      }
      return player;
