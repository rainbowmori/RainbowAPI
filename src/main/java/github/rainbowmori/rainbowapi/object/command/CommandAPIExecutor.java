...
import github.rainbowmori.rainbowapi.object.command.executors.ExecutorType;
import github.rainbowmori.rainbowapi.object.command.executors.IExecutorNormal;
import github.rainbowmori.rainbowapi.object.command.executors.IExecutorResulting;
import github.rainbowmori.rainbowapi.object.command.executors.IExecutorTyped;
	...
	private int execute(List<? extends IExecutorTyped> executors, CommandSender sender, Object[] args)
		...
		if (isForceNative()) {
			...
			throw new WrapperCommandSyntaxException(new SimpleCommandExceptionType(
					new LiteralMessage("This command has no implementations for %s"
