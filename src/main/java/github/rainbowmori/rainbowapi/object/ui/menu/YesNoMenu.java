package github.rainbowmori.rainbowapi.object.ui.menu;
...
public class YesNoMenu<P extends Plugin> extends MenuHolder<P> {
     ...
     * @param yesAction the action to perform when the yes-button is clicked
     * @param noAction the action to perform when the no-button is clicked
     * @see github.rainbowmori.rainbowapi.object.ui.GuiInventoryHolder#GuiInventoryHolder(Plugin, Inventory)
     */
     ...
     * @param yesAction the action to perform when the yes-button is clicked
     * @param noAction the action to perform when the no-button is clicked
     * @see github.rainbowmori.rainbowapi.object.ui.GuiInventoryHolder#GuiInventoryHolder(GuiListener, Plugin, Inventory)
     */
