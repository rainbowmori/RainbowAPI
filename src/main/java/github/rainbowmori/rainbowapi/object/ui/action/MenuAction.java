...
public interface MenuAction {
	...
	static MenuAction createAction(String identifier) {
		...
		return switch (args[0]) {
			...
			default -> throw new RuntimeException("buttonのargがおかしいです" + identifier);
		};
	}
	
	static MenuAction of(BiConsumer<MenuHolder<?>, InventoryClickEvent> consumer) {
