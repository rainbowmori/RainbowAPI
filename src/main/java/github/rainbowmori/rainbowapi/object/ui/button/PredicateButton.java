...
/**
 * これは{@link PermissionButton}の一般化である。
 * 述語が満たされたときに、他のボタンに委譲するボタンを表現する。
...
public class PredicateButton<MH extends MenuHolder<?>> implements MenuButton<MH> {
    ...
    /**
     * 述語が満たされたときに、このボタンが委譲するボタンを取得する。
     * このメソッドをオーバーライドする実装は、決して null を返してはならない。
     * @return デリゲートボタン
     */
    ...
    /**
     * このボタンをメニューに追加できるかどうかを決定する。
     * デフォルトの実装では、デリゲートに委任します。
     *
